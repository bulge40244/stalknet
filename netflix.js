...
(function () {
    ...
    /* VCLUB */
    function netflix_constructor() {

        this.layer_name = 'netflix';
        ...
        this.load_genres = function (alias) {
            ...
            _debug('netflix.load_genres', alias);
        ...
        this.hide = function (do_not_reset) {
            ...
            _debug('netflix.hide', do_not_reset);
        ...
        this.init_search_box = function () {
            _debug('netflix.init_search_box');
            var scope = this;
        ...
        this.disable_color_buttons = function () {
            _debug('netflix.disable_color_buttons');
        ...
        this.enable_color_buttons = function () {
            _debug('netflix.enable_color_buttons');
        ...
        this.check_for_storage_selection = function (play_url) {
            _debug('netflix.check_for_storage_selection', play_url);
        ...
        this.check_price = function (video_id) {
            _debug('netflix.check_price', video_id);
        ...
        this.check_for_pass = function (play_url, storage) {
            _debug('netflix.check_for_play', play_url, storage);
        ...
        this.check_for_series = function (play_url, storage) {
            _debug('netflix.check_for_series', play_url, storage);
        ...
        this.get_link = function (video_cmd, episode, callback) {
            ...
            if (video_cmd.indexOf('://') < 0) {
                ...
                stb.player.on_create_link = function (result) {
                    _debug('netflix.on_create_link', result);
        ...
        this.play = function (play_url, storage, callback) {
            _debug('netflix.play', play_url, storage);
        ...
        this.add_download = function (item, url) {
            _debug('netflix.add_download', item, url);
        ...
        this.set_ad_ended_time = function (ad_id, end_time, total_time, ended) {
            _debug('netflix.set_ad_ended_time', ad_id, end_time, total_time, ended);
        ...
        this.set_not_ended = function (video_id, series, end_time, file_id) {
            _debug('netflix.set_not_ended', video_id, series, end_time, file_id);
        ...
        this.set_ended = function (video_id) {
            _debug('netflix.set_ended', video_id);
        ...
        this.sidebar_switcher = function () {
            _debug('netflix.sidebar_switcher');
    ...
    netflix_constructor.prototype = new ListLayer();

    var netflix = new netflix_constructor();

    netflix.bind();
    netflix.init();

    netflix.init_short_info();

    //netflix.set_wide_container();
    netflix.set_middle_container();

    if (single_module.indexOf('netflix') == -1) {
        netflix.init_left_ear(word['ears_back']);
    }

    netflix.init_right_ear(word['ears_about_movie']);

    netflix.init_color_buttons([
        {"label": word['vclub_view'], "cmd": netflix.view_switcher},
        {"label": word['vclub_sort'], "cmd": netflix.sort_menu_switcher},
        {"label": word['vclub_fav'], "cmd": netflix.add_del_fav},
        {"label": word['vclub_find'], "cmd": netflix.other_switcher}
    ]);

    //netflix.init_info();

    netflix.init_sidebar();

    netflix.sidebar.init_items("abc", {"header": word['vclub_by_letter'], "width": 26, "align": "center"});
    netflix.sidebar.init_items("genre", {"header": word['vclub_by_genre'], "width": 95});
    netflix.sidebar.init_items("years", {"header": word['vclub_by_year'], "width": 45});

    netflix.sidebar.bind();
    ...
    netflix.init_search_box();

    netflix.init_view_menu(
        [
            {
    ...
    netflix.init_header_path(word['netflix_title']);

    netflix.sidebar.dependency = [netflix.sort_menu, netflix.search_box, netflix.view_menu, netflix.other_menu];
    netflix.sort_menu.dependency = [netflix.sidebar, netflix.search_box, netflix.view_menu, netflix.other_menu];
    netflix.search_box.dependency = [netflix.sidebar, netflix.sort_menu, netflix.view_menu, netflix.other_menu];
    netflix.view_menu.dependency = [netflix.sidebar, netflix.sort_menu, netflix.search_box, netflix.other_menu];
    netflix.other_menu.dependency = [netflix.sidebar, netflix.sort_menu, netflix.search_box, netflix.view_menu];
    ...
    stb.load(
        ...
        function (result) {
            ...
            module.netflix.categories = categories;
                        ...
                        "cmd": (function (category) {
                            ...
                            return function () {
                                ...
                                if (category.censored) {
                                    module.netflix.parent_password_promt.callback = function () {
                                        main_menu.hide();
                                        module.netflix._show(category);

                                        module.netflix.history.push({
                                            "page": module.netflix.cur_page,
                                            "row": module.netflix.cur_row,
                                            "load_params": module.netflix.load_params
                                        })
                                    };
                                    module.netflix.parent_password_promt.show();
                                } else {
                                    main_menu.hide();
                                    module.netflix._show(category);
            ...
            main_menu.add(word['netflix_title'], map, 'mm_ico_default.png', '', module.netflix);
